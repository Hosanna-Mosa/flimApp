import { Country, getFlagEmoji } from '@/utils/country';

// [name, ISO 3166-1 alpha-2, calling code] — bundled so the picker never
// depends on a network call (the REST Countries v3 API this used to fetch
...
const RAW: [string, string, string][] = [
  ...
  ['Cape Verde', 'CV', '+238'], ['Cayman Islands', 'KY', '+1345'], ['Central African Republic', 'CF', '+236'],
  ['Chad', 'TD', '+235'], ['Chile', 'CL', '+56'], ['China', 'CN', '+86'],
  ['Colombia', 'CO', '+57'], ['Comoros', 'KM', '+269'], ['Congo', 'CG', '+242'],
  ['Congo (DRC)', 'CD', '+243'], ['Cook Islands', 'CK', '+682'], ['Costa Rica', 'CR', '+506'],
  ['Croatia', 'HR', '+385'], ['Cuba', 'CU', '+53'], ['Curaçao', 'CW', '+599'],
  ...
  ['Eswatini', 'SZ', '+268'], ['Ethiopia', 'ET', '+251'], ['Faroe Islands', 'FO', '+298'],
  ...
  ['Greenland', 'GL', '+299'], ['Grenada', 'GD', '+1473'], ['Guadeloupe', 'GP', '+590'],
  ['Guam', 'GU', '+1671'], ['Guatemala', 'GT', '+502'], ['Guernsey', 'GG', '+44'],
  ...
  ['Ireland', 'IE', '+353'], ['Isle of Man', 'IM', '+44'], ['Israel', 'IL', '+972'],
  ['Italy', 'IT', '+39'], ['Ivory Coast', 'CI', '+225'], ['Jamaica', 'JM', '+1876'],
  ['Japan', 'JP', '+81'], ['Jersey', 'JE', '+44'], ['Jordan', 'JO', '+962'],
  ...
  ['Malta', 'MT', '+356'], ['Marshall Islands', 'MH', '+692'], ['Martinique', 'MQ', '+596'],
  ...
  ['Nigeria', 'NG', '+234'], ['Niue', 'NU', '+683'], ['North Korea', 'KP', '+850'],
  ...
  ['Poland', 'PL', '+48'], ['Portugal', 'PT', '+351'], ['Puerto Rico', 'PR', '+1787'],
  ['Qatar', 'QA', '+974'], ['Réunion', 'RE', '+262'], ['Romania', 'RO', '+40'],
  ...
  ['Sierra Leone', 'SL', '+232'], ['Singapore', 'SG', '+65'], ['Sint Maarten', 'SX', '+1721'],
  ...
  ['Turkmenistan', 'TM', '+993'], ['Turks and Caicos Islands', 'TC', '+1649'], ['Tuvalu', 'TV', '+688'],
  ['Uganda', 'UG', '+256'], ['Ukraine', 'UA', '+380'], ['United Arab Emirates', 'AE', '+971'],
  ['United Kingdom', 'GB', '+44'], ['United States', 'US', '+1'], ['Uruguay', 'UY', '+598'],
  ['US Virgin Islands', 'VI', '+1340'], ['Uzbekistan', 'UZ', '+998'], ['Vanuatu', 'VU', '+678'],
  ['Vatican City', 'VA', '+39'], ['Venezuela', 'VE', '+58'], ['Vietnam', 'VN', '+84'],
  ['Yemen', 'YE', '+967'], ['Zambia', 'ZM', '+260'], ['Zimbabwe', 'ZW', '+263'],
];

export const COUNTRIES: Country[] = RAW.map(([name, code, callingCode]) => ({
  name,
  code,
  callingCode,
